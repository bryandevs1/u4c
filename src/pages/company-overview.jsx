          ...
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-lg-6 col-md-9">
              <div className="about-text">
                ...
                <Link to="/about" className="main-btn mt-40">
                  {" "}
            ...
            <div className="row justify-content-center fancy-icon-boxes">
              ...
              >
                <div className="fancy-box-item mt-30">
                  ...
                  <div className="content">
                    <h4 className="title">
                      <Link to="/project-details">Medical &amp; Health</Link>
                    </h4>
                    <p>School, Collage &amp; University</p>
                  </div>
                </div>
              ...
              >
                <div className="fancy-box-item mt-30">
                  ...
                  <div className="content">
                    <h4 className="title">
                      <Link to="/project-details">Clothes</Link>
                    </h4>
                    <p>School, Collage &amp; University</p>
                  </div>
                </div>
              ...
              >
                <div className="fancy-box-item mt-30">
                  ...
                  <div className="content">
                    <h4 className="title">
                      <Link to="/project-details">Video &amp; Films</Link>
                    </h4>
                    <p>School, Collage &amp; University</p>
                  </div>
                </div>
              ...
              >
                <div className="fancy-box-item mt-30">
                  ...
                  <div className="content">
                    <h4 className="title">
                      <Link to="/project-details">Organic Foods</Link>
                    </h4>
                    <p>School, Collage &amp; University</p>
                  </div>
                </div>
            ...
            <div className="col-xl-6 col-lg-10">
              <div className="image-text-block text-block-two mb-lg-50">
                ...
                <div className="block-content">
                  ...
                  <Link to="/about" className="main-btn bordered-btn mt-40">
